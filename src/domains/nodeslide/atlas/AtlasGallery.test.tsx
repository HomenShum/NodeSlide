...
/** Wiring guard: a gallery no URL reaches is a file, not a feature. */
describe('Atlas gallery route', () => {
  it('is reachable at ?domain=atlas and stays out of the studio bundle', () => {
    const app = readFileSync('src/App.tsx', 'utf8');
    expect(app).toContain("domain === 'atlas'");
    expect(app).toContain("lazy(() =>\n  import('./domains/nodeslide/atlas/AtlasGallery')");
    expect(app).toContain('<AtlasGallery />');
  });
});
