...
// Carried forward from the destination repo (nodeslide 39a9ebf, 2026-07-20). This assertion was
// added after parity forked and has no counterpart in parity's fixture-matrix suite, so porting
// the suite without it would have silently dropped delegation-hierarchy coverage.
describe('TraceWaterfall delegated agent hierarchy', () => {
