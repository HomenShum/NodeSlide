...
export function createCandidatePatchPlan(input: {
  ...
  for (const operation of operations) {
    // Structural rather than a list of deck-level opcodes. An enumerated list
    // is wrong the day a new slide-less operation is added, and it silently
    // widens the patch scope instead of failing; asking whether the operation
    // names a slide cannot drift.
