...
import { NODESLIDE_ARTIFACT_MANIFEST_FILE, verifyNodeSlideArtifactSet } from '@nodeslide/cli';
...
const from = await verifyNodeSlideArtifactSet(fromDirectory);
const to = await verifyNodeSlideArtifactSet(toDirectory);
